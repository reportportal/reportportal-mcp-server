...
func (lr *TestItemResources) toolGetTestItemsByFilter() (tool mcp.Tool, handler server.ToolHandlerFunc) {
	...
	return mcp.NewTool(
			...
			options...), utils.WithAnalytics(lr.analytics, "get_test_items_by_filter", func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (lr *TestItemResources) toolGetTestItemById() (mcp.Tool, server.ToolHandlerFunc) {
	return mcp.NewTool("get_test_item_by_id",
		...
		), utils.WithAnalytics(lr.analytics, "get_test_item_by_id", func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			project, err := utils.ExtractProject(ctx, request)
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
...
func (lr *TestItemResources) toolGetTestItemAttachment() (mcp.Tool, server.ToolHandlerFunc) {
	return mcp.NewTool("get_test_item_attachment_by_id",
		...
		), utils.WithAnalytics(lr.analytics, "get_test_item_attachment_by_id", func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			project, err := utils.ExtractProject(ctx, request)
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
			...
			if err != nil {
				return mcp.NewToolResultError(
					fmt.Sprintf("failed to read attachment body: %v", err),
				), nil
			}
...
func (lr *TestItemResources) toolGetTestItemLogsByFilter() (tool mcp.Tool, handler server.ToolHandlerFunc) {
	return mcp.NewTool(
		...
		), utils.WithAnalytics(lr.analytics, "get_test_item_logs_by_filter", func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			slog.Debug("START PROCESSING")
			project, err := utils.ExtractProject(ctx, request)
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
...
func (lr *TestItemResources) toolGetTestSuitesByFilter() (tool mcp.Tool, handler server.ToolHandlerFunc) {
	...
	return mcp.NewTool(
			...
			options...), utils.WithAnalytics(lr.analytics, "get_test_suites_by_filter", func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			slog.Debug("START PROCESSING")
			project, err := utils.ExtractProject(ctx, request)
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
...
func (lr *TestItemResources) toolGetProjectDefectTypes() (mcp.Tool, server.ToolHandlerFunc) {
	return mcp.NewTool(
			...
			lr.projectParameter,
		), utils.WithAnalytics(lr.analytics, "get_project_defect_types", func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			project, err := utils.ExtractProject(ctx, request)
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
...
func (lr *TestItemResources) toolUpdateDefectTypeForTestItems() (mcp.Tool, server.ToolHandlerFunc) {
	return mcp.NewTool(
		...
		), utils.WithAnalytics(lr.analytics, "update_defect_type_for_test_items", func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			project, err := utils.ExtractProject(ctx, request)
			if err != nil {
				return mcp.NewToolResultError(err.Error()), nil
			}
