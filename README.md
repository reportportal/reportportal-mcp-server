...
| Delete Test Cases from Test Plan | Removes one or more test cases from an existing TMS test plan. **Mutates TMS data.** | `test-plan-id` (required, integer ≥ 1), `test-case-ids` (required, non-empty array of integers) |
